...
# ./local/chain/compare_wer_general.sh tdnn_1a_sp tdnn_opgru_1a_sp
# System                      tdnn_1a_sp tdnn_opgru_1a_sp
# WER on dev                      14.06     13.90
# WER on test                     15.88     15.83
# CER on dev                       6.26      6.07
# CER on test                      7.39      7.37
# Final train prob               -0.041    -0.028
# Final valid prob               -0.062    -0.042
# Final train prob (xent)        -0.813    -0.415
# Final valid prob (xent)       -0.9681   -0.5009
# Num-parameters               12382686  20312470                                                
